function [ out_pointcloud, R, T ] = estimate_then_merge(useTheseNumbers, sampleSize, sampleTech, maxIterations)
    ...
    for i = useTheseNumbers(2:length(useTheseNumbers))
        ...
        if ( strcmpi( sampleTech, 'normals' ) )
            ...
            [output, R_obtained, T_obtained] = ICP(Base, Target, sampleSize, sampleTech, maxIterations, normals);
            ...
            [output, R_obtained, T_obtained] = ICP(Base, Target, sampleSize, sampleTech, maxIterations);
        end
