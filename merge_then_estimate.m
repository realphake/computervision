function [ out_pointcloud, R, T ] = merge_then_estimate(useTheseNumbers, sampleSize, sampleTech, maxIterations)
    ...
    for i = useTheseNumbers(2:length(useTheseNumbers))
        ...
        if ( strcmpi( sampleTech, 'normals' ) )
            ...
            [output, R_obtained, T_obtained] = ICP(Base, out_pointcloud, sampleSize, sampleTech, maxIterations, normals);
            ...
            [output, R_obtained, T_obtained] = ICP(Base, out_pointcloud, sampleSize, sampleTech, maxIterations);
        end
